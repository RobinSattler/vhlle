...
class VtkOutput {
  ...
  public:
    ...
    void write(Hydro h, const std::string &quantities);
    void write_header(std::ofstream &file, Hydro h,
                      const std::string &description);
    void write_vtk_scalar(std::ofstream &file, Hydro h,
                          const std::string &quantity);
    void write_vtk_vector(std::ofstream &file, Hydro h,
                          const std::string &quantity);
    void write_vtk_tensor(std::ofstream &file, Hydro h,
                          const std::string &quantity);
