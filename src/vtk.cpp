...
void VtkOutput::write_header(std::ofstream &file, Hydro h,
...
void VtkOutput::write_vtk_scalar(std::ofstream &file, Hydro h,
...
void VtkOutput::write_vtk_vector(std::ofstream &file, Hydro h,
                                 const std::string &quantity) {
...
void VtkOutput::write_vtk_tensor(std::ofstream &file, Hydro h,
                                 const std::string &quantity) {
  for (int i = 0; i < 4; i++) {
    for (int j = 0; j < 4; j++ ) {
...
void VtkOutput::write(Hydro h, const std::string &quantities) {
